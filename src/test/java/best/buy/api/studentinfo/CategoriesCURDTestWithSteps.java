...
import best.buy.api.playgroundInfo.CategoriesSteps;
...
public class
CategoriesCURDTestWithSteps extends TestBase {

    static String name = "Mobile Phone" + TestUtils.getRandomValue();
    static String id = "XYZ123"+ TestUtils.getRandomValue();
